		...
		<section class="ftco-section">
			<div class="container">
				<div class="row dept align-items-center">
					...
					<div class="col-md-6 img" style="background-image: url(template/images/work-1.jpg);"></div>
				</div>
				...
				<div class="row dept align-items-center">
					...
					<div class="col-md-6 img" style="background-image: url(template/images/work-5.jpg);"></div>
				</div>
				...
				<div class="row dept align-items-center">
					...
					<div class="col-md-6 img" style="background-image: url(template/images/work-4.jpg);"></div>
				</div>
			</div>
		</section>
