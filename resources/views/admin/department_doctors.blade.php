...
<div class="content">
    <div class="row">
        <div class="col-sm-4 col-3">
            <h4 class="page-title">{{$department->dept_name}} Doctors</h4>
        </div>
    ...
    <div class="row doctor-grid justify-content-center">
        @foreach($department->doctors as $d)
        <div class="col-md-4 col-sm-4  col-lg-3">
            <div class="profile-widget">
                <div class="doctor-img">
                    <a class="avatar" href="profile.html"><img alt="" src="{{asset('admin/img/fake.jpg')}}"></a>
                </div>
                ...
                <h4 class="doctor-name text-ellipsis">{{$d->doctor_name}}</h4>
                <div class="user-country">
                    <div class="doc-prof">{{$d->qualification}}</div>
                </div>
            </div>
        </div>
        @endforeach
