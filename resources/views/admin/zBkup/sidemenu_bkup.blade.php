        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul  class="sitebar">
               ...
               <li class="">
                ...
                <!-- <li class="">
                    <a href="{{url('appointments2')}}" class="act"><i class="fa fa-calendar"></i> <span>Appointments2</span></a>
                </li> -->
                <li class="">
                ...
                <li class="">
                    <a href="{{url('patientCare')}}" class="act"><i class="fa fa-file-text-o"></i> <span>Doctor
                            Patient Care</span></a>
                </li>
                <li class="submenu">
