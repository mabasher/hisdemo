                ...
                <form class="form-inline" role="form">
                    <table id="p_scents">
                        <thead>
                            ...
                            <tr>
                                <th>
                                    <input id="testNameSrc" class="testNameSrc" list="" autocomplete="off">
                                    <select class="form-control testName2" name="test_no" id="testName2">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body border border-info">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="grantTotal" placeholder="Grant Total" />
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    $(function() {
        ...
        $(document).on('click', "#addScnt", function() {
            ...
            <td><input type="text" class="form-control text-center disFixed" data-id="disFixed" data-dept="${i}" placeholder="Disc Fixed "/></td>
    ...
    // $(document).on('keyup', '.testNameSrc', function() {
    //         let testName = $(this).val();
    //         getTestSearch(testName);
    // })


    function getTestSearch(testName) {
        $.ajax({
            url: "{{url('investigations')}}/" + testName,
            type: 'get',
            success: function(data) {
                $('#testName2').append(data);
                console.log(data);
            }
        })
    }
