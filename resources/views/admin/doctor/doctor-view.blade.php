...
<div class="content">
    ...
    <div class="modal fade" id="edit_doctor" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            ...
                            <div class="form-row">
                                <div class="col-md-6">
                                    <label>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input gender" type="radio" name="gender" id="gender_female" value="F">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="doctorName" class="doctorName" name="doctor_name" placeholder="Doctor Name">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" id="qualification" name="qualification[]" multiple="" data-placeholder="Select Qualification" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" id="clinicalInterest" name="special_interest[]" multiple="" data-placeholder="Select Clinical Interest" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                            @foreach($specialty as $sp)
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="contactNo" name="contact_no" placeholder="Mobile/Phone No">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label>Office Phone</label>
                                        <input class="form-control" type="text" id="officePhone" name="office_phone" placeholder="Office Phone">
                                    </div>
                                </div>
                            </div>
