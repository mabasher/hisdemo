                ...
                <div class="widget category-widget">
                    <div class="row form-group mb-0">
                        <div class="col-md-5 text-success">
                            ...
                            <h4 class="text-secondary">{{$lastVisit? 'Last Visited: '. $lastVisit->consultation->designation.' '.$lastVisit->consultation->doctor_name:''}}</h4>
                        </div>
                        <div class="col-md-5 text-success">
                            <h4>PID :&nbsp;<span>{{$patientPrescrip->patAppinfo->salutation_id.' '.$patientPrescrip->patAppinfo->ful_name}}</span></h4>
                            <h4>Age : &nbsp;<span id="age"></span>,&nbsp;{{$patientPrescrip->patAppinfo->gender == 'M'?'Male':'Female'}}</h4>
                            <h4>Care Giver :&nbsp;<span class="enq-parent-email">{{$patientPrescrip->consultation->designation.' '.$patientPrescrip->consultation->doctor_name}}</span> </h4>
                        ...
                        <div class="col-md-2">
                            <div class="widget category-widget text-center" style="padding: 10px;"> 
                                <a href="{{url('patientCare')}}" class="btn btn-sm btn-success mb-1"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                <a id="chiefCompleint" class="btn btn-sm btn-info mb-1"><i class="fa fa-cc text-white" aria-hidden="true"></i></a>
                                <a type="button" class="btn btn-info btn-sm mb-1" data-toggle="modal" data-target="#vitalSign"><i class="fa fa-stethoscope text-white" aria-hidden="true"></i></a>
                                <a href="{{url('prescriptionReports/'.$patientPrescrip->reg_no)}}" class="btn btn-sm btn-success mb-1"><i class="fa fa-print" aria-hidden="true"></i></a>
                                <a type="button" class="btn btn-info btn-sm mb-1 text-white" data-toggle="modal" data-target="#recentVitalSign">Recent Vitals</a>
                                <a type="button" class="btn btn-info btn-sm mb-1 text-white" data-toggle="modal" data-target="#recentCC">Recent C.C.</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form autocomplete="off" method="POST" action="{{url('investigationSave')}}">
                                ...
                                <div class="col-md-8 m-auto">
                                    <div class="form-row text-info mb-3">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input investivation" type="radio" name="service_type" id="pathology" value="P" checked>
                                                <h4 class="form-check-label" for="gender_male">Pathology & Diagnostics</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input investivation" type="radio" name="service_type" id="service" value="S">
                                                <h4 class="form-check-label" for="gender_female">Services</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input investivation" type="radio" name="service_type" id="radiology" value="I">
                                ...
                                <div class="col-md-10 m-auto">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="srvtype" placeholder="Service Type">
                                            </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label>Status</label>
                                            <select class="custom-select" name="inv_status">
                                                <option value="R">Routine</option>
                                                <option value="U">Urgent</option>
                                                <option value="S">Stat</option>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <textarea rows="2" cols="2" class="form-control disableEnable" placeholder="Lab Instruction" id="labInstrc" name="lab_instruction"></textarea>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label>Additional Instruction</label>
                                            <textarea rows="2" cols="2" class="form-control disableEnable" placeholder="Additional Instruction" id="additInstrc" name="additional_instruction"></textarea>
                                        </div>
                                    </div>
...
<div class="modal fade" id="chiefCompModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div id="srcHistoryIllness" style="display: block;">
                        <div class="text-center">
                            <div class="custom-radio-button">
                                <div class="form-row">
                                    <input type="radio" id="male" name="q1" value="M" class="genderbutton" data-position="maleFront" checked>
                                    <label for="male" title="Male">
                                        <span>
                                            <i class="fa fa-male fa-2x" aria-hidden="true"></i>
                                        </span>
                                    </label>
                                    <input type="radio" id="female" name="q1" value="F" class="genderbutton" data-position="femaleFront">
                                    <label for="female" title="Female"><span><i class="fa fa-female fa-2x" aria-hidden="true"></i>
                                        </span></label>&nbsp;&nbsp;
                                    <a title="Add Attributes" id="add"><i class="fa fa-plus text-success" aria-hidden="true"></i></a>
                                    <a title="Add Attributes" id="remove"><i class="fa fa-minus text-danger" aria-hidden="true"></i></a>
                                    &nbsp;&nbsp;
                                    <div id="newAttrib">
                                        <input type="text" id="attrName" width="50px" placeholder="Add Attributes" class="form-control">
                                    </div>
                                    <div id="saveAttrib">
                                        <button type="button" title="Save" id="saveData" class="btn btn-outline-success"><i class="fa fa-save" aria-hidden="true"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        @if($recentVitals != null)
                            <tr class="text-center text-success">
                                <td colspan="2"><h4>{{$recentVitals->created_at? 'Taken Time'.': '.$recentVitals->created_at:'Taken Time:'}}</h4></td>
                            </tr>
                            <tr>
                                <td>{{$recentVitals->temp_f? 'Temp(deg F)'.': '.$recentVitals->temp_f:'Temp(deg F):'}}</td>
                                <td>{{$recentVitals->temp_c? 'Temp(deg C)'.': '.$recentVitals->temp_c:'Temp(deg C):'}}</td>
                            </tr>
                            <tr>
                                <td>{{$recentVitals->pulse? 'Pulse/min'.': '.$recentVitals->pulse:'Pulse/min:'}}</td>
                                <td>{{$recentVitals->respiratory_rate? 'RR/min'.': '.$recentVitals->respiratory_rate:'RR/min:'}}</td>
                            </tr>
                            <tr>
                                <td>{{$recentVitals->bp_higher? 'Systolic'.': '.$recentVitals->bp_higher:'Systolic:'}}</td>
                                <td>{{$recentVitals->bp_lower? 'Diastolic'.': '.$recentVitals->bp_lower:'Diastolic:'}}</td>
                            </tr>
                            <tr>
                                <td>{{$recentVitals->weight_kg? 'Weight(kg)'.': '.$recentVitals->weight_kg:'Weight(kg):'}}</td>
                                <td>{{$recentVitals->height_cm? 'Height(cm)'.': '.$recentVitals->height_cm:'Height(cm):'}}</td>
                            </tr>
                        @endif
                        </table>
                    </div>
